...
int my_package(LweSample* result, LweSample* st, LweSample* c,
  ...
  bootsAND(temp_nodes[988], temp_nodes[987], temp_nodes[966], bk);

  temp_nodes[992] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[992], temp_nodes[991], temp_nodes[966], bk);

  temp_nodes[1008] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1008], temp_nodes[976], temp_nodes[975], bk);

  temp_nodes[997] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsOR(temp_nodes[997], temp_nodes[978], temp_nodes[980], bk);
  ...
  bootsAND(temp_nodes[989], temp_nodes[988], temp_nodes[965], bk);

  temp_nodes[993] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[993], temp_nodes[992], temp_nodes[964], bk);

  temp_nodes[1009] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1009], temp_nodes[1008], temp_nodes[974], bk);

  temp_nodes[998] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsOR(temp_nodes[998], temp_nodes[997], temp_nodes[985], bk);

  temp_nodes[999] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsOR(temp_nodes[999], temp_nodes[970], temp_nodes[989], bk);

  temp_nodes[994] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[994], temp_nodes[993], temp_nodes[963], bk);

  temp_nodes[1010] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1010], temp_nodes[1009], temp_nodes[973], bk);

  temp_nodes[996] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsCOPY(temp_nodes[996], st, bk);

  temp_nodes[1001] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsNOT(temp_nodes[1001], temp_nodes[998], bk);

  temp_nodes[1000] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsOR(temp_nodes[1000], temp_nodes[999], temp_nodes[994], bk);

  temp_nodes[1011] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1011], temp_nodes[1010], temp_nodes[972], bk);

  temp_nodes[1003] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1003], temp_nodes[996], temp_nodes[1001], bk);

  temp_nodes[1002] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsNOT(temp_nodes[1002], temp_nodes[1000], bk);

  temp_nodes[1012] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1012], temp_nodes[1011], temp_nodes[968], bk);

  temp_nodes[1006] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsNOT(temp_nodes[1006], temp_nodes[969], bk);

  temp_nodes[1004] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1004], temp_nodes[1003], temp_nodes[1002], bk);

  temp_nodes[1013] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1013], temp_nodes[1012], temp_nodes[1006], bk);

  temp_nodes[1005] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsNOT(temp_nodes[1005], temp_nodes[1004], bk);

  temp_nodes[1014] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1014], temp_nodes[1013], temp_nodes[971], bk);

  temp_nodes[1007] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsAND(temp_nodes[1007], temp_nodes[968], temp_nodes[1005], bk);

  temp_nodes[959] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsCONSTANT(temp_nodes[959], 1, bk);

  temp_nodes[960] = new_gate_bootstrapping_ciphertext(bk->params);
  bootsCONSTANT(temp_nodes[960], 0, bk);

  bootsCOPY(&result[7], temp_nodes[970], bk);
  bootsCOPY(&result[6], temp_nodes[969], bk);
  bootsCOPY(&result[5], temp_nodes[1007], bk);
  bootsCOPY(&result[4], temp_nodes[967], bk);
  bootsCOPY(&result[3], temp_nodes[966], bk);
  bootsCOPY(&result[2], temp_nodes[965], bk);
  bootsCOPY(&result[1], temp_nodes[964], bk);
  bootsCOPY(&result[0], temp_nodes[963], bk);
  bootsCOPY(&st[0], temp_nodes[1014], bk);
